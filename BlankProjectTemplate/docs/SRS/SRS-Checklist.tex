...
\item Introduction
  ...
  \item Scope of the reuqirements is an abstract version of the assumptions
...
\item Solution Characteristics Specification
  ...
  \item Each assumptions are referenced at least once
...
\item Functional Requirements
  \begin{todolist}
  \item IMs and (possibly) TMs and GMs are referenced as appropriate by the requirements.
  \end{todolist}
